    ...
    return ( 
      <div>
        ...
        A closure is a small piece of lace fabric, usually about 4"x4", with individual strands of hair ventilated through and knotted directly to the lace. Our Lace Closures are without a doubt undetectable and appear to be coming directly from your scalp. Our closures blend effortlessly with our bundles finishing off your style with a virtually seamless weave. We carry 12", 14", 16" in stock (18" and 20" available upon request.) All lace closures measure at 4"x4".
          ...
          <div className="fb-share-button" data-href="https://www.hairbyadara.com/closures/body-wave" data-layout="button" data-size="small" data-mobile-iframe="true">
            <a target="_blank" href="https://www.facebook.com/sharer.php?u=https://www.hairbyadara.com/closures/body-wave" className="fb-xfbml-parse-ignore">Share</a>
            <a target="_blank" href="https://twitter.com/share?text=Brazilian%20Kinky%20Curl&url=https://www.hairbyadara.com/closures/body-wave" className="share-twitter">Tweet</a>
            <a target="_blank" href="https://pinterest.com/pin/create/button/?url=https://www.hairbyadara.com/closures/body-wave" className="share-pinterest">Pin it</a>
            <a target="_blank" href="https://fancy.com/fancyit?ItemURL=https://www.hairbyadara.com/closures/body-wave" className="share-fancy">Fancy</a>
            <a target="_blank" href="https://plus.google.com/share?url=https://www.hairbyadara.com/closures/body-wave" className="share-google">+1</a>
          </div>
        </div>
        <div>
          <h3>More from this collection</h3>
          <div className="closure-frontal-collection">
            <a href="https://www.hairbyadara.com/closures/kinky-curl-closure"><img src={kinkyClosure} id="kc-collection-pic1" width="100%" height="100%"/></a>
            <p>Brazilian Kinky Curl Closure</p>
          </div>
          <div className="closure-frontal-collection">
            <a href="https://www.hairbyadara.com/closures/kinky-curl-frontal"><img src={kinkyFrontal}  id="kf-collection-pic1" width="100%" height="100%"/></a>
            <p>Brazilian Kinky Curl Frontal</p>
          </div>
          <div className="closure-frontal-collection">
            <a href="https://www.hairbyadara.com/closures/straight-closure"><img src={straightClosure}  id="sc-collection-pic1" width="100%" height="100%"/></a>
            <p>Brazilian Mink Straight Closure</p>
          </div>
          <div className="closure-frontal-collection">
            <a href="https://www.hairbyadara.com/closures/straight-frontal"><img src={straightFrontal}  id="sf-collection-pic1" width="100%" height="100%"/></a>
