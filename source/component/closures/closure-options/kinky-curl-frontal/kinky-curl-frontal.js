    ...
    return ( 
      <div>
        ...
        A closure is a small piece of lace fabric, usually about 4"x4", with individual strands of hair ventilated through and knotted directly to the lace. Our Lace Closures are without a doubt undetectable and appear to be coming directly from your scalp. Our closures blend effortlessly with our bundles finishing off your style with a virtually seamless weave. We carry 12", 14", 16" in stock (18" and 20" available upon request.) All lace closures measure at 4"x4".
          ...
          <div className="fb-share-button" data-to="https://www.hairbyadara.com/closures/kinky-curl-frontal" data-layout="button" data-size="small" data-mobile-iframe="true">
            <h3> Share this product </h3>
            <BrowserRouter>
              <React.Fragment>
                <Link target="_blank" to="https://www.facebook.com/sharer.php?u=https://www.hairbyadara.com/closures/kinky-curl-frontal" className="fb-xfbml-parse-ignore">Share</Link>
                <Link target="_blank" to="https://twitter.com/share?text=Brazilian%20Kinky%20Curl&url=https://www.hairbyadara.com/closures/kinky-curl-frontal" className="share-twitter">Tweet</Link>
                <Link target="_blank" to="https://pinterest.com/pin/create/button/?url=https://www.hairbyadara.com/closures/kinky-curl-frontal" className="share-pinterest">Pin it</Link>
                <Link target="_blank" to="https://fancy.com/fancyit?ItemURL=https://www.hairbyadara.com/closures/kinky-curl-frontal" className="share-fancy">Fancy</Link>
                <Link target="_blank" to="https://plus.google.com/share?url=https://www.hairbyadara.com/closures/kinky-curl-frontal" className="share-google">+1</Link>
              </React.Fragment>
            </BrowserRouter>
          </div>
        </div>
          ...
          <BrowserRouter>
            <React.Fragment>
              <div className="closure-frontal-collection">
                <Link to ="https://www.hairbyadara.com/closures/body-wave-closure"><img src={bodyWaveClosure} id="bw-collection-pic5" width="100%" height="100%"/></Link>
                <p>Brazilian Body Wave Closure</p>
              </div>
              <div className="closure-frontal-collection">
                <Link to ="https://www.hairbyadara.com/closures/kinky-curl-closure"><img src={kinkyClosure} id="kc-collection-pic5" width="100%" height="100%"/></Link>
                <p>Brazilian Kinky Curl Closure</p>
              </div>
              <div className="closure-frontal-collection">
                <Link to ="https://www.hairbyadara.com/closures/straight-closure"><img src={straightClosure} id="sc-collection-pic5" width="100%" height="100%"/></Link>
                <p>Brazilian Mink Straight Closure</p>
              </div>
              <div className="closure-frontal-collection">
                <Link to ="https://www.hairbyadara.com/closures/straight-frontal"><img src={straightFrontal} id="sf-collection-pic5" width="100%" height="100%"/></Link>
