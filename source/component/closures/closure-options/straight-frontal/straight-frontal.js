...
export default class StraightFrontal extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      length : '',
    ...
    return ( 
      <div>
        <div id="straight-frontal-pic">
          <img src={straightFrontal} width="100%" height="100%"/>
        </div>
        <div id="straight-frontal-info">
          <h1>Brazilian Mink Straight Frontal</h1>
          <h3>$ 145.00</h3>
          <p>Length</p>
          <select name="straight frontal length" id="straight-frontal-length">
          ...
          <p>Hair Type</p>
          <select name="straight frontal type" id="straight-frontal-type">
            <option value="lace">Lace</option>
          </select>
          <p>Quantity</p>
          <select name="straight frontal quantity" id="straight-frontal-quantity">
        ...
        A closure is a small piece of lace fabric, usually about 4"x4", with individual strands of hair ventilated through and knotted directly to the lace. Our Lace Closures are without a doubt undetectable and appear to be coming directly from your scalp. Our closures blend effortlessly with our bundles finishing off your style with a virtually seamless weave. We carry 12", 14", 16" in stock (18" and 20" available upon request.) All lace closures measure at 4"x4".
          ...
          <div class="fb-share-button" data-href="https://www.hairbyadara.com/closures/straight-frontal" data-layout="button" data-size="small" data-mobile-iframe="true">
            <a target="_blank" href="https://www.facebook.com/sharer.php?u=https://www.hairbyadara.com/closures/straight-frontal" class="fb-xfbml-parse-ignore">Share</a>
            <a target="_blank" href="https://twitter.com/share?text=Brazilian%20Kinky%20Curl&url=https://www.hairbyadara.com/closures/straight-frontal" class="share-twitter">Tweet</a>
            <a target="_blank" href="https://pinterest.com/pin/create/button/?url=https://www.hairbyadara.com/closures/straight-frontal" class="share-pinterest">Pin it</a>
            <a target="_blank" href="https://fancy.com/fancyit?ItemURL=https://www.hairbyadara.com/closures/straight-frontal" class="share-fancy">Fancy</a>
            <a target="_blank" href="https://plus.google.com/share?url=https://www.hairbyadara.com/closures/straight-frontal" class="share-google">+1</a>
          </div>
        </div>
        <div>
