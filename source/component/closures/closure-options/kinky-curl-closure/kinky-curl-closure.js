...
class KinkyCurlClosure extends React.Component {
  ...
  render() {
    return (
      <div>
        <h5 className="header-links"><Link className="header-links" to="../../">Home </Link> > <Link className="header-links" to="../closures">Closures </Link>> Brazilian Kinky Curl Closure </h5>
