...
export default class KinkyCurlClosure extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      length : '',
    ...
    return ( 
      <div>
        ...
        <div id="kinky-curl-closure-info">
          ...
          <select name="kinky closure length" id="kinky-closure-length">
          ...
          <select name="kinky closure type" id="kinky-closure-type">
            <option value="lace">Lace</option>
            <option value="silk">Silk</option>
          </select>
          <p className="label">Quantity</p>
          <select name="kinky closure quantity" id="kinky-closure-quantity">
        ...
        A closure is a small piece of lace fabric, usually about 4"x4", with individual strands of hair ventilated through and knotted directly to the lace. Our Lace Closures are without a doubt undetectable and appear to be coming directly from your scalp. Our closures blend effortlessly with our bundles finishing off your style with a virtually seamless weave. We carry 12", 14", 16" in stock (18" and 20" available upon request.) All lace closures measure at 4"x4".
          ...
          <div class="fb-share-button" data-href="https://www.hairbyadara.com/closures/kinky-curl-closure" data-layout="button" data-size="small" data-mobile-iframe="true">
            <a target="_blank" href="https://www.facebook.com/sharer.php?u=https://www.hairbyadara.com/closures/kinky-curl-closure" class="fb-xfbml-parse-ignore">Share</a>
            <a target="_blank" href="https://twitter.com/share?text=Brazilian%20Kinky%20Curl&url=https://www.hairbyadara.com/closures/kinky-curl-closure" class="share-twitter">Tweet</a>
            <a target="_blank" href="https://pinterest.com/pin/create/button/?url=https://www.hairbyadara.com/closures/kinky-curl-closure" class="share-pinterest">Pin it</a>
            <a target="_blank" href="https://fancy.com/fancyit?ItemURL=https://www.hairbyadara.com/closures/kinky-curl-closure" class="share-fancy">Fancy</a>
            <a target="_blank" href="https://plus.google.com/share?url=https://www.hairbyadara.com/closures/kinky-curl-closure" class="share-google">+1</a>
          </div>
        </div>
        <div>
          <h3>More from this collection</h3>
          <div className="closure-frontal-collection">
            <a href="https://www.hairbyadara.com/closures/body-wave-closure"><img src={bodyWaveClosure} id="bw-collection-pic2" width="100%" height="100%"/></a>
            <p>Brazilian Body Wave Closure</p>
          </div>
          <div className="closure-frontal-collection">
            <a href="https://www.hairbyadara.com/closures/kinky-curl-frontal"><img src={kinkyFrontal} id="kc-collection-pic2" width="100%" height="100%"/></a>
            <p>Brazilian Kinky Curl Frontal</p>
          </div>
          <div className="closure-frontal-collection">
            <a href="https://www.hairbyadara.com/closures/straight-closure"><img src={straightClosure} id="sc-collection-pic2" width="100%" height="100%"/></a>
            <p>Brazilian Mink Straight Closure</p>
          </div>
          <div className="closure-frontal-collection">
            <a href="https://www.hairbyadara.com/closures/straight-frontal"><img src={straightFrontal} id="sf-collection-pic2" width="100%" height="100%"/></a>
